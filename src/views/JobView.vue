        ...
        <main>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <p class="mb-4">
              ...
              with experience working with modern JavaScript frameworks such as Vue or Angular.
            </p>
        ...
        <aside>
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="my-2">
              ...
              We pride ourselves on delivering high-quality products and services to our clients
          ...
          <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            >Edit Job</a>
            <button
              class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full w-full block mt-4"
            >
              Delete Job
            </button>
          </div>
